        ...
        <div>
            ...
            <table id="datos">
                ...
                <tbody>
                    <tr>
                        <th>
                            <p id="proveedor">Nombre: {{$v->nombre}}<br>
                                {{$v->tipo_identificacion}}-COMPRA: {{$v->num_compra}}<br>
                                Dirección: {{$v->direccion}}<br>
                                Teléfono: {{$v->telefono}}<br>
                                Email: {{$v->email}}</</p> </th> </tr> </tbody> </table> </div> <div id="fact">
                                <p>{{$v->tipo_identificacion}} COMPRA</p>
                                <span> {{$v->num_compra}} </span>
        </div>
    </header>
    <br>
            ...
            <table id="facproducto">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td>
                            <p align="right">${{number_format($c->total,0, ",", ".")}}
                                <p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p align="right">$ {{number_format($c->total*$c->impuesto,0, ",", ".")}}</p>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="3">
                        ...
                        <td>
                            <p align="right">$ {{number_format($c->total+($c->total*$c->impuesto),0, ",", ".")}}</p>
                        </td>
                    </tr>
                    @endforeach
                </tfoot>
