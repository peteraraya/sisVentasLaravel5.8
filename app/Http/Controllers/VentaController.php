...
class VentaController extends Controller
{
    ...
    public function show($id) // Detalle de la venta
    {
    ...
    public function destroy(Request $request) // Permite anular una venta
    {
    ...
    public function pdf(Request $request, $id) // re
    {
